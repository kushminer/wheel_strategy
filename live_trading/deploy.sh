#!/bin/bash
# Deploy CSP Strategy as a Cloud Run Job
#
# Usage:
#   ./deploy.sh              # Build + deploy
#   ./deploy.sh --build-only # Build image only (no deploy)
#
# Prerequisites:
#   gcloud auth login
...
echo "  gcloud scheduler jobs create http csp-daily-run \\"
